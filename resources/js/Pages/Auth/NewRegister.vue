        ...
        <jet-authentication-card-new>
            ...
            <form @submit.prevent="submit">
                ...
                <div class="mt-4">
                    ...
                    <jet-input id="username" type="text" class="mt-1 block w-full text-black" 
                ...
                <div class="mt-4">
                    ...
                    <select v-model="form.gender"
                        class="block mt-1 w-full border-gray-300 text-black 
                            focus:border-indigo-300 focus:fing-indigo-200 focus:ring-opacity-50 
