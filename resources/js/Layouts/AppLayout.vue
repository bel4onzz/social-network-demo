        ...
        <nav class="bg-white border-b border-gray-100 w-full fixed z-20">
            ...
            <div class="w-full mx-auto px-4 sm:px-6 lg:px-2">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6 sm:justify-end w-1/2">
                        <!-- Settings Dropdown -->
                                ...
                                <template #trigger>
                                    ...
                                    <button type="button" v-else
                                        class="flex items-center text-sm font-medium text-gray-500 
                                            hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-transparent
